...
public class Swamp {
	...
	ArrayList<String> fluff = new ArrayList<>();
      ...
      fluff.add(" An ominous caw of a raven calls somewhere above you , your sense of dispare grows");
      fluff.add("Yoy can just about make out the sun shining throught the fog, if only you knew what time it was it could have helped");
      fluff.add("Its unuseually cold here, the water leaches your strength");
...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	public void disttoo() {
		xdisplace = Math.min(10 - (xloc - xtreasure), (xtreasure - xloc));
		ydisplace = Math.min(10 - (yloc - ytreasure), (ytreasure - yloc));
		totdist =  Math.sqrt(xdisplace * xdisplace + ydisplace * ydisplace);
	}
}